<?PHP include("include/top.php"); ?>
                            ...
                            <section id="products">
										...
										$sonuc = mysql_query("select urun_id,model,beden,fiyat,aciklama,damatlik_resim from damatlik_ekle");
                                ...
                                <?php
                                   echo' <span align="center" class="product_content">';
												...
												echo '<img src="'.$oku["damatlik_resim"].'" width="150" height="150"/></br></br></br>';
												echo 'Model : '.$oku["model"]."<br>Beden: ".$oku["beden"]."<br>Fiyat: ".$oku["fiyat"]." TL".'<br><br>';
						
									echo "<a href='damatlik_detay.php?urun_id=$oku[urun_id]'>İncele</a>";	
