...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
 ...
 <div class="formm">
                           ...
                           <span class="form_content">Rezervasyon formunu eksiksizce doldurarak rezerve yapabilirsiniz.</span><br>
                           <br>
                         <b style="color:maroon; font-size:13px; padding:5px; text-decoration:underline"> DİKKAT = </b> <b style="color:#000; font-size:12px; padding:5px">Kiralama ve Bırakma tarihleri arasında en az 5 gün olması gerekiyor. Beden uymaması vb. sorunlar için düğün ve ya nişan tarihinden en az 2 gün önceden ve düğünden sonra en az 2 gün ara olması gereklidir. Aksi takdirde hiç bir soruna kefil değiliz.</b>
                           <br><br>
                            <form action="rezervasyon2.php" method="post" enctype="multipart/form-data">
                            	<table class="form_carregister">
                                    ...
                                    <tr>
                                    	<td>Kiralama Tarihi</td><td>:</td><td><input type="date" name="kiralama"/></td>
                                    </tr> 
                                    <tr>
                                    	<td>Bırakma Tarihi</td><td>:</td><td><input type="date" name="birakma"/></td>
                                    </tr> 
                                    <tr>
                                    	<td>Açıklama</td><td>:</td><td><textarea name="aciklama" rows="3" cols="26" style="resize:none;"></textarea></td>
                                    </tr>
                                    <tr>
                                        <td></td> <td><input type="submit" value="Rezerve Et"/></td> <td><input type="reset" value="Formu Temizle"/><br></td>
                                    </tr>
                           	 </table>
                            </form>
