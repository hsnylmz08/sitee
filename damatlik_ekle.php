...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
 ...
 <div class="formm">
                           ...
                           <span class="form_content">Damatlık Ekleme formunu eksiksizce doldurarak damatlık ilanı ekleyebilirsiniz.</span><br><br><br>
                            <form action="damatlik_ekle2.php" method="post" enctype="multipart/form-data">
                            	<table class="form_carregister">
                                    ...
                                    <tr>
                                        ...
                                        <select name="model" id="select1">
                                            ...
                                            <option>Siyah Damatlık</option>
                                            <option>Lacivert Damatlık</option>
                                            <option>Beyaz Damatlık</option>
                                            <option>Krem Damatlık</option>
                                            <option>Smokin Damatlık</option>
                                        </select></td>
                                    </tr>
                                     <tr>
                                    ...
                                    <tr>
                                    	<td>Damatlik Resmi</td><td>:</td><td><input type="file" name="damatlik_resim"/></td>
                                    </tr>
                                    <tr>
                                        <td></td> <td><input type="submit" value="Damatlık Ekle"/></td> <td><input type="reset" value="Formu Temizle"/><br></td>
                                    </tr>
                           	 </table>
                            </form>
                           </div>
